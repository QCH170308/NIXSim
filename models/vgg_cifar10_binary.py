...
class VGG_Cifar10(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.infl_ratio=1; # defl_ratio, used 2 for half sized network
        self.features = nn.Sequential(
            ...
            BinarizeConv2d(512//self.infl_ratio, 256, kernel_size=3, padding=1, bias=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            nn.BatchNorm2d(256),
            nn.Hardtanh(inplace=True)
        ...
        self.classifier = nn.Sequential(
            BinarizeLinear(256 * 4 * 4, 1024, bias=True),
            nn.BatchNorm1d(1024),
            nn.Hardtanh(inplace=True),
            #nn.Dropout(0.5),
